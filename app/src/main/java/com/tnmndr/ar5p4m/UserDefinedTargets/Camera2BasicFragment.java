...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir(null), "texture.jpg");
    }
    ...
    private void requestStoragePermission() {
        if (FragmentCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            new ConfirmationDialog.ConfirmationDialogStorage().show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // For still image captures, we use the largest/new preview size available size.
   ...
   private void captureStillPicture() {
       try {
           ...
           Log.d(TAG,"still saving" + mFile.toString());
    ...
    public void onClick(View view) {
        switch (view.getId()) {
           case R.id.picture: {
               Log.d(TAG,"saving" + mFile.toString());
                  takePicture();
              ...
              new CountDownTimer(2000, 1000) {
                  public void onFinish() {
                      ...
                      Intent UserDefinedTargets = new Intent(getActivity(), com.tnmndr.ar5p4m.UserDefinedTargets.UserDefinedTargets.class);

                      Camera2BasicFragment.this.startActivity(UserDefinedTargets);
                  }
